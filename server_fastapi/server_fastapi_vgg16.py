...
import __vgg16_prediction_model as __vgg16_prediction_model
import logging
...
# Load the model once
try:
    vgg16_model = __vgg16_prediction_model.load_model()
...
async def sample_prediction():
    try:
        result = await __vgg16_prediction_model.prediction_model(vgg16_model)
